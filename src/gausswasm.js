...
Module.onRuntimeInitialized = async function () {
	document.getElementById('button').addEventListener("click", async function() {
		...
		// pgauss = Module.cwrap('printgauss','', ['number','number', 'number','number', 'number', 'number', 'number', 'number']) 

		_printgauss(len/3,len1/3,offset,offset2,gauss_ptr,mean_ptr,first_ptr,second_ptr,gcolor,mcolor,fcolor,scolor);
